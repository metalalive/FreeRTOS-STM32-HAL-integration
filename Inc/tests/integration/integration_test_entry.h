...
//         * Recursive Mutex (also priority inheritance)
//         * Task notification
//         * Register Test (for STM32F446 port)
//
...
//
// [to-do] check following :
//     * tickless idle & different low-power modes supported in STM32F446 port
//     * synchronization between ISR and application tasks
//     * serialize the integration tests in order to simplify test execution environment
//       e.g. each interation test case starts running after previous one is completed.
//
